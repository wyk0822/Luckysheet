...
export default {
    ...
    loadUrl: "http://192.168.58.32:8081/api/v1/luckysheet/66c69ed4ca1b3f37cc11d7a5/", // 配置loadUrl的地址，luckysheet会通过ajax请求表格数据，默认载入status为1的sheet数据中的所有data，其余的sheet载入除data字段外的所有字段
    loadSheetUrl: "", //配置loadSheetUrl的地址，参数为gridKey（表格主键） 和 index（sheet主键合集，格式为[1,2,3]），返回的数据为sheet的data字段数据集合
    gridKey: "", // 表格唯一标识符
    updateUrl: "ws://192.168.58.32:8081/luckysheet/3/66c69ed4ca1b3f37cc11d7a5/", //表格数据的更新地址
